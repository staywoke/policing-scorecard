        ...
        <div class="content">
          ...
          <div>
            <p class="c8"><a href="#ftnt_ref1" id="ftnt1">[1]</a><span class="c6">&nbsp;13 police departments reported that either they do not collect or possess data specifying the number of uses of less lethal force or that they would not provide us with
                these data despite being required to under the California Public Records Act. These departments received a 0% for the less lethal force component of their </span><span class="c9 c6">police violence score</span><span class="c6">. Departments
                indicating they needed more time to compile and send these data are excluded from the calculation of less lethal force rates until such data are provided</span><span class="c4">.</span></p>
          </div>
          <div>
