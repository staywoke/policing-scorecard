      ...
      <div class="section bg-orange">
        <div class="content chart-summary">
          <div class="left">
            ...
            <p>There were substantial disparities in police treatment during these stops. <strong>Both agencies were more likely to search black people, people perceived to be LGBT and people perceived to have disabilities during a stop.</strong> Moreover, in situations where police had the most discretion, they tended to engage in discriminatory search practices. For example, <strong>San Diego police were 44% more likely to search Latinx people and 133% more likely to search black people than white people during a routine traffic stop</strong> - especially for equipment violations. Moreover, <strong>San Diego police were 23% more likely to search a black person and 60% more likely to search a Latinx person based solely on the consent of the person being searched</strong> - a type of search where officers have the most discretion. San Diego sheriff's deputies were also more likely to conduct these types of searches, called "consent searches", on black and Latinx people during a stop.</p>
      ...
      <div class="section">
        <div class="content chart-summary">
          <div class="left">
            ...
            <p>Moreover, the contraband these departments did report finding rarely posed a public safety risk justifying the use of this intrusive police tactic. Drugs or drug paraphernalia represented two-thirds of all contraband reportedly found while fewer than 1% of searches by either department reportedly found a gun. And while San Diego police and sheriff's departments were more likely to search black and Latinx people during routine traffic stops, they were <strong>less likely to find contraband during these searches</strong>. This suggests both departments are over-searching people in general, with little to no public safety benefit, while engaging in biased policing towards communities of color in particular.</p>
          ...
          <div class="right">
            <iframe title="San Diego police and Sheriff's deputy searches were less likely to find contraband on people of color." aria-label="Grouped Column Chart" id="datawrapper-chart-Z2VK2" src="//datawrapper.dwcdn.net/Z2VK2/2/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",function(a){if(void 0!==a.data["datawrapper-height"])for(var e in a.data["datawrapper-height"]){var t=document.getElementById("datawrapper-chart-"+e)||document.querySelector("iframe[src*='"+e+"']");t&&(t.style.height=a.data["datawrapper-height"][e]+"px")}})}();</script>
          </div>
        </div>
      </div>
      ...
      <div class="section bg-blue">
        <div class="content chart-summary">
          <div class="left">
            ...
            <p>We obtained detailed data on 88,372 arrests made from 2016-2018 by San Diego Police Department and 28,119 arrests made in 2016 by San Diego Sheriff’s Department. Analyzing these data, we find that <strong>misdemeanor offenses comprise the vast majority of arrests - making up 71% of all SDPD arrests and 67% of all SDSD arrests.</strong> Of these low-level offenses, drug possession, status offenses and quality of life offenses made up a significant proportion - accounting for 34% of SDPD arrests and 34% of SDSD arrests.</p>
            <p>This policing approach, which uses arrests as a response to low-level offenses, disproportionately impacts black communities. For example, black people were 4.1x more likely than white people to be arrested by SDPD for drug possession, despite research showing black and white people use and sell drugs at similar rates. Both agencies made as many arrests for drug possession alone as they did for all Part 1 Violent and Property Crimes <strong>combined.</strong></p>
          </div>
          <div class="right">
            <div class="right">
      ...
      <div class="section">
        ...
        <div class="section">
          ...
          <div class="content chart-summary padded no-pad-top number-list">
            ...
            <p><strong>San Diego Sheriff's Department killed 3 people with tasers from 2016-2018 - representing 17% of all taser deaths statewide during this period.</strong> San Diego Sheriff's Department used tasers in 582 incidents during this time, 2x more often per arrest than San Diego Police Department. As such, the department should impose new restrictions on the use of tasers and emphasize using de-escalation tactics and lesser forms of physical force in these situations instead. If these reforms fail to curb deaths and serious injuries from taser use, SDSD should consider banning the use of tasers entirely.</p>
