...
<div class="stat-wrapper">
  ...
  <p>Used More Force per Arrest than <?= num($scorecard['report']['percentile_less_lethal_force'], 0, '%', true) ?> of Depts</p>
  <p>
  ...
  <p class="note">^&nbsp; Includes batons, strangleholds, tasers & other police weapons &nbsp;&nbsp;</p>
  <?php endif; ?>
