...
<?php foreach($stateData['police-department'] as $index => $department): ?>
        <li class="police-department"><a href="<?= $isProd ? $card['url_pretty'] : $department['url'] ?>"<?= ($type === 'police-department' && $location === $department['slug']) ? ' class="selected-city"' : '' ?>><?= $department['agency_name'] ?> Police</a></li>
<?php endforeach; ?>
<?php foreach($stateData['sheriff'] as $index => $department): ?>
        <li class="sheriff"><a href="<?= $isProd ? $card['url_pretty'] : $department['url'] ?>"<?= ($type === 'sheriff' && $location === $department['slug']) ? ' class="selected-city"' : '' ?>><?= $department['agency_name'] ?> Sheriff</a></li>
<?php endforeach; ?>
      </ul>
    </div>
  </div>
